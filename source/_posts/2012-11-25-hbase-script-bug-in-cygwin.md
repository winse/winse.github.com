---
layout: post
title: "hbase-0.94启动脚本在cygwin环境的BUG"
date: 2012-11-25 19:17
comments: true
categories: [hbase]
---
...
修改如下(其实就是**把cygwin路径转换的代码位置移动**了一下)：
...
或者修改下`append_path`方法也可以。

* * * 
[【原文地址】](http://winseclone.iteye.com/blog/1734818)
